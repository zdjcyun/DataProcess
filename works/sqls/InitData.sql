...
insert into bfb_t_param_config_list values ('kafka.consumer.topics','demo_topic_1,demo_topic_2');
...
insert into bfb_t_param_config_list values ('spark.demo_topic_1.process.class','com.service.data.spark.streaming.process.DefaultTextProcess');
/* demo_topic_2消息对应的处理类，根据实际情况配置 */
insert into bfb_t_param_config_list values ('spark.demo_topic_2.process.class','com.service.data.spark.streaming.process.DefaultJsonProcess');
